...
// MDCoords2D
#define COCOAPODS_POD_AVAILABLE_MDCoords2D
#define COCOAPODS_VERSION_MAJOR_MDCoords2D 0
#define COCOAPODS_VERSION_MINOR_MDCoords2D 1
#define COCOAPODS_VERSION_PATCH_MDCoords2D 0
